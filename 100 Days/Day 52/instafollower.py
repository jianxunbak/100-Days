...
class InstaFollower:
    ...
    def follow(self):
        buttons = self.driver.find_elements(By.CSS_SELECTOR, value=".xyi19xy button")
        ...
        for items in buttons:
            try:
                ...
                WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//button[contains(text(), "
                                                                                           "'Cancel')]"))).click()
                sleep(1.1)